function [dPTE, PTE] = PTE_tf3d(data, delay, binsize)
...
% This code was adatped from freely available code 
% original source https://figshare.com/articles/dataset/Phase_Transfer_Entropy/3847086
...
if isdeployed && ~strcmp(binsize, 'scott') && ~strcmp(binsize, 'otnes')
    binsize = str2double(binsize); % convert string to number for compiled files
end
